...
describe('single line', () => {
  test('parses single depends on', () => {
    const text =
      'This PR depends on https://github.com/silverorange/swat/pull/20';
  ...
  test('parses multiple depends on', () => {
    const text =
      'This PR depends on https://github.com/silverorange/swat/pull/20 and https://github.com/silverorange/swat/pull/21';
    const dependencies = getDependencies(text);
    expect(dependencies).toEqual([
      'https://api.github.com/repos/silverorange/swat/pulls/20',
  ...
  test('parses single depends upon', () => {
    const text =
      'This PR depends upon https://github.com/silverorange/swat/pull/20';
    const dependencies = getDependencies(text);
    expect(dependencies).toEqual([
      'https://api.github.com/repos/silverorange/swat/pulls/20'
    ]);
  ...
  test('parses single requires', () => {
    const text =
      'This PR requires https://github.com/silverorange/swat/pull/20';
    const dependencies = getDependencies(text);
    expect(dependencies).toEqual([
      'https://api.github.com/repos/silverorange/swat/pulls/20'
    ]);
...
describe('HTTP vs HTTPS', () => {
  test('parses HTTP links', () => {
    const text =
      'This PR depends on http://github.com/silverorange/swat/pull/20';
    const dependencies = getDependencies(text);
    expect(dependencies).toEqual([
      'https://api.github.com/repos/silverorange/swat/pulls/20'
    ]);
...
describe('repo special characters', () => {
  test('parses repos with dashes', () => {
    const text =
      'This PR depends on http://github.com/silver-orange/swat-tests/pull/20';
    const dependencies = getDependencies(text);
    expect(dependencies).toEqual([
      'https://api.github.com/repos/silver-orange/swat-tests/pulls/20'
    ]);
  });

  test('parses repos with underscores', () => {
    const text =
      'This PR depends on http://github.com/silver_orange/swat_tests/pull/20';
    const dependencies = getDependencies(text);
    expect(dependencies).toEqual([
      'https://api.github.com/repos/silver_orange/swat_tests/pulls/20'
    ]);
  });

  test('parses repos with numbers', () => {
    const text =
      'This PR depends on http://github.com/silverorange/swat2/pull/20';
    const dependencies = getDependencies(text);
    expect(dependencies).toEqual([
      'https://api.github.com/repos/silverorange/swat2/pulls/20'
    ]);
  });
});
